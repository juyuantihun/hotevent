...
ALTER TABLE timeline ADD INDEX idx_name_time_range (name, start_time, end_time);
ALTER TABLE timeline ADD INDEX idx_name_status (name, status);
ALTER TABLE timeline ADD INDEX idx_created_at_status (created_at, status);